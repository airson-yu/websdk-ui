<template>
  <div id="sdk_webapp">
    ...
    <GroupCreateModal v-show="group_create_modal_show"
                      v-on:on-tg-create-cancel="hideGroupCreateModal()"></GroupCreateModal>
    ...
    <VoiceConfirmModal v-show="voice_confirm.modal_show" :status="voice_confirm.status" :uname="voice_confirm.uname"
                       :target="voice_confirm.target"
                       v-on:on-call-confirm-cancel="hideVoiceConfirmModal()"></VoiceConfirmModal>

    <VoicePttConfirmModal v-show="voice_ptt_confirm.modal_show" :status="voice_ptt_confirm.status"
                          :uname="voice_ptt_confirm.uname"
                          :target="voice_ptt_confirm.target"
                          v-on:on-call-ptt-confirm-cancel="hideVoicePttConfirmModal()"></VoicePttConfirmModal>
    ...
    <VideoConfirmModal v-show="video_confirm.modal_show" :status="video_confirm.status" :uname="video_confirm.uname"
                       :target="video_confirm.target"
                       v-on:on-vcall-confirm-cancel="hideVideoConfirmModal()"></VideoConfirmModal>
    ...
    <div v-if="debug" style="width: 43%;float: left;text-align: left;padding:0px 15px;">
      ...
      <div style="margin-top:15px;">
        ...
        <Button style="margin:5px;width: 150px;" type="primary" @click="req_query_history_gps()">req_query_history_gps
        </Button>
        ...
        <Button style="margin:5px;width: 150px;" type="primary" @click="req_force_enter_group()">req_force_enter_group
        </Button>
        <Button style="margin:5px;width: 150px;" type="success" @click="req_force_leave_group()">req_force_leave_group
        </Button>
        ...
        <Button style="margin:5px;width: 150px;" type="success" @click="req_stop_play_video()">req_stop_play_video
        </Button>
        ...
        <Button style="margin:5px;width: 150px;" type="primary" @click="req_delete_grp(75291)">req_delete_grp75291
        </Button>
        <Button style="margin:5px;width: 150px;" type="primary" @click="req_stop_video(68505)">req_stop_video68505
        </Button>
      </div>
      <div style="height:40px;line-height: 40px;margin: 0 auto;border-bottom:solid 1px gray;">UI调试</div>
      <div style="margin-top:15px;">
        <Button style="margin:5px;width: 105px;" type="primary" @click="localShowIMModalUser(param_uid1)">
          打开个人68505/66250
        </Button>
        <Button style="margin:5px;width: 105px;" type="primary" @click="localShowIMModalUser(68509)">打开个人68509</Button>
        <Button style="margin:5px;width: 105px;" type="success" @click="localShowIMModalGroup(param_tgid1)">打开群组74752
        </Button>
        <Button style="margin:5px;width: 105px;" type="success" @click="localShowIMModalGroup(param_tgid2)">打开群组74753
        </Button>
...
export default {
  ...
  methods: {
    ...
    showUserModal: function (uid, extUid, callback, init_param_obj) {
      logger.debug('showUserModal uid:{}', uid);
      let that = this;
    ...
    showGroupModal: function (tgid, callback) {
      logger.debug('showGroupModal tgid:{}', tgid);
      let that = this;
      window.websdk.request.groupRequest.getGroupInfo([tgid], function (rsp) {
    ...
    showCreateGroupModal: function (callback) {
      logger.debug('showCreateGroupModal');
      let that = this;
    ...
    showPstnVoiceCallModal: function (target, telno, callback, init_param_obj) {
      logger.debug('showPstnVoiceCallModal target:{}', target);
      let that = this;
