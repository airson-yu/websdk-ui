<template>
  <Modal v-model="group_create_modal_show" class="sdk-modal sdk-user-modal sdk-group-create-modal" scrollable
         :title="modal_title"
         :width=400 :z-index="1000" :mask="false" v-on:on-cancel="on_hide_modal"
         v-on:on-visible-change="on_visible_change">
